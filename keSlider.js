;(function ($, window, document) {
    ...
    keSlider.prototype.initSlider = function(firstTime) {
        ...
        if (this.options.carousel && this.originalItems.length > 1) {
            this.cloneItems();
        } else {
            ...
            if (moveTime === 0) {
                ...
                this.animateSlide(this.itemsWrapper, position, false, moveTime, function () {
                    if (_this.items.eq(index).hasClass('keSlider__item--clone')) {
                        ...
                        if (_this.options.arrows && this.originalItems.length > 1) {
                            _this.activeArrows();
                        }
                        if (_this.options.navigation && _this.originalItems.length > 1) {
    ...
    keSlider.prototype.createArrows = function() {
        ...
        this.arrowLeft = $('<button class="keSlider__arrow keSlider__arrow--left">' + this.options.prevLabel + '</button>');
        this.arrowRight = $('<button class="keSlider__arrow keSlider__arrow--right">' + this.options.nextLabel + '</button>');
    ...
    keSlider.prototype.deleteNavigation = function() {
        if (typeof this.navigation !== 'undefined' && this.navigation !== null && this.originalItems.length > 1) {
            this.disableNavigation();
